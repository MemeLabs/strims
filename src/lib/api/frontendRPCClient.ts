...
export default class FrontendRPC extends RPCHost {
  ...
  public updateProfile(
    v: pb.IUpdateProfileRequest = new pb.UpdateProfileRequest()
  ...
  public updateNetwork(
    v: pb.IUpdateNetworkRequest = new pb.UpdateNetworkRequest()
  ...
  public getNetworkMemberships(
    ...
    return this.expectOne(
      this.call("getNetworkMemberships", new pb.GetNetworkMembershipsRequest(v))
    );
  }
  public deleteNetworkMembership(
    ...
    return this.expectOne(
      this.call("deleteNetworkMembership", new pb.DeleteNetworkMembershipRequest(v))
    );
  }
  public createBootstrapClient(
    ...
    return this.expectOne(
      this.call("createBootstrapClient", new pb.CreateBootstrapClientRequest(v))
    );
  }
  public updateBootstrapClient(
    ...
    return this.expectOne(
      this.call("updateBootstrapClient", new pb.UpdateBootstrapClientRequest(v))
    );
  }
  public deleteBootstrapClient(
    ...
    return this.expectOne(
      this.call("deleteBootstrapClient", new pb.DeleteBootstrapClientRequest(v))
    );
  }
  ...
  public getIngressStreams(
    v: pb.IGetIngressStreamsRequest = new pb.GetIngressStreamsRequest()
  ): GenericReadable<pb.GetIngressStreamsResponse> {
  ...
  public startSwarm(
    v: pb.IStartSwarmRequest = new pb.StartSwarmRequest()
  ): Promise<pb.StartSwarmResponse> {
    return this.expectOne(this.call("startSwarm", new pb.StartSwarmRequest(v)));
  }
  public writeToSwarm(
    v: pb.IWriteToSwarmRequest = new pb.WriteToSwarmRequest()
  ): Promise<pb.WriteToSwarmResponse> {
    return this.expectOne(this.call("writeToSwarm", new pb.WriteToSwarmRequest(v)));
  }
  public stopSwarm(
    v: pb.IStopSwarmRequest = new pb.StopSwarmRequest()
  ): Promise<pb.StopSwarmResponse> {
  ...
  public callChatClient(
    ...
    return this.expectOne(this.call("callChatClient", new pb.CallChatClientRequest(v)));
  }
  ...
  public createNetworkInvitation(
    ...
    return this.expectOne(
      this.call("createNetworkInvitation", new pb.CreateNetworkInvitationRequest(v))
    );
  }
  ...
  public publishNetworkToBootstrapPeer(
    ...
    return this.expectOne(
      this.call("publishNetworkToBootstrapPeer", new pb.PublishNetworkToBootstrapPeerRequest(v))
    );
  }
}
