...
registerType("FundingBalance", pb.FundingBalance);
registerType("FundingTransaction", pb.FundingTransaction);
registerType("FundingSummary", pb.FundingSummary);
registerType("FundingTestRequest", pb.FundingTestRequest);
registerType("FundingTestResponse", pb.FundingTestResponse);
registerType("FundingGetSummaryRequest", pb.FundingGetSummaryRequest);
registerType("FundingGetSummaryResponse", pb.FundingGetSummaryResponse);
registerType("FundingCreateSubPlanRequest", pb.FundingCreateSubPlanRequest);
registerType("FundingCreateSubPlanResponse", pb.FundingCreateSubPlanResponse);
