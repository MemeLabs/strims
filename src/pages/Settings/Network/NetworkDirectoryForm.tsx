...
export interface NetworkDirectoryFormData {
...
export interface NetworkDirectoryFormProps {
  onSubmit: (data: NetworkDirectoryFormData) => void;
  error: Error;
  loading: boolean;
  values?: NetworkDirectoryFormData;
}

const NetworkDirectoryForm: React.FC<NetworkDirectoryFormProps> = ({
  onSubmit,
  error,
  loading,
  values = {},
}) => {
  const { handleSubmit, control, watch, clearErrors } = useForm<NetworkDirectoryFormData>({
    mode: "onBlur",
...
export default NetworkDirectoryForm;
