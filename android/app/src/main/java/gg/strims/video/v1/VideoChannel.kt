...
class VideoChannel(
  ...
  @field:WireField(
    tag = 1001,
    adapter = "gg.strims.video.v1.VideoChannel${'$'}Local#ADAPTER"
  )
  val local: Local? = null,
  @field:WireField(
    tag = 1002,
    adapter = "gg.strims.video.v1.VideoChannel${'$'}LocalShare#ADAPTER",
    jsonName = "localShare"
  )
  val local_share: LocalShare? = null,
  @field:WireField(
    tag = 1003,
    adapter = "gg.strims.video.v1.VideoChannel${'$'}RemoteShare#ADAPTER",
