...
class EgressOpenStreamResponse(
  @field:WireField(
    tag = 1,
    adapter = "gg.strims.video.v1.EgressOpenStreamResponse${'$'}Open#ADAPTER"
  )
  val open: Open? = null,
  @field:WireField(
    tag = 2,
    adapter = "gg.strims.video.v1.EgressOpenStreamResponse${'$'}Data#ADAPTER"
  )
  val data: Data? = null,
  @field:WireField(
    tag = 3,
    adapter = "gg.strims.video.v1.EgressOpenStreamResponse${'$'}Error#ADAPTER"
  )
