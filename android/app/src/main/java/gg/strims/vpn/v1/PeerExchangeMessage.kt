...
class PeerExchangeMessage(
  @field:WireField(
    tag = 1,
    adapter = "gg.strims.vpn.v1.PeerExchangeMessage${'$'}Request#ADAPTER"
  )
  val request: Request? = null,
  @field:WireField(
    tag = 2,
    adapter = "gg.strims.vpn.v1.PeerExchangeMessage${'$'}Response#ADAPTER"
  )
  val response: Response? = null,
  @field:WireField(
    tag = 3,
    adapter = "gg.strims.vpn.v1.PeerExchangeMessage${'$'}Offer#ADAPTER"
  )
  val offer: Offer? = null,
  @field:WireField(
    tag = 4,
    adapter = "gg.strims.vpn.v1.PeerExchangeMessage${'$'}Answer#ADAPTER"
  )
  val answer: Answer? = null,
  @field:WireField(
    tag = 5,
    adapter = "gg.strims.vpn.v1.PeerExchangeMessage${'$'}IceCandidate#ADAPTER",
    jsonName = "iceCandidate"
  )
  val ice_candidate: IceCandidate? = null,
  @field:WireField(
    tag = 6,
    adapter = "gg.strims.vpn.v1.PeerExchangeMessage${'$'}CallbackRequest#ADAPTER",
