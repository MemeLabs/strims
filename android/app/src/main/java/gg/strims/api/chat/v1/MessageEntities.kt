...
// Source: strims.chat.v1.MessageEntities in chat/v1/chat.proto
...
class MessageEntities(
  ...
  @field:WireField(
    tag = 7,
    adapter = "gg.strims.api.chat.v1.MessageEntities${'$'}GenericEntity#ADAPTER",
  ...
  @field:WireField(
    tag = 1,
    adapter = "gg.strims.api.chat.v1.MessageEntities${'$'}Link#ADAPTER",
  ...
  @field:WireField(
    tag = 2,
    adapter = "gg.strims.api.chat.v1.MessageEntities${'$'}Emote#ADAPTER",
    label = WireField.Label.REPEATED
  )
  ...
  @field:WireField(
    tag = 3,
    adapter = "gg.strims.api.chat.v1.MessageEntities${'$'}Nick#ADAPTER",
    label = WireField.Label.REPEATED
  )
  ...
  @field:WireField(
    tag = 4,
    adapter = "gg.strims.api.chat.v1.MessageEntities${'$'}Tag#ADAPTER",
    label = WireField.Label.REPEATED
  )
  ...
  @field:WireField(
    tag = 5,
    adapter = "gg.strims.api.chat.v1.MessageEntities${'$'}CodeBlock#ADAPTER",
    label = WireField.Label.REPEATED,
    jsonName = "codeBlocks"
  )
  ...
  @field:WireField(
    tag = 6,
    adapter = "gg.strims.api.chat.v1.MessageEntities${'$'}Spoiler#ADAPTER",
    label = WireField.Label.REPEATED
  )
  ...
  companion object {
    ...
    val ADAPTER: ProtoAdapter<MessageEntities> = object : ProtoAdapter<MessageEntities>(
      ...
      "type.googleapis.com/strims.chat.v1.MessageEntities", 
      PROTO_3, 
      null
    ) {
  ...
  class Bounds(
    ...
    companion object {
      ...
      val ADAPTER: ProtoAdapter<Bounds> = object : ProtoAdapter<Bounds>(
        FieldEncoding.LENGTH_DELIMITED, 
        Bounds::class, 
        "type.googleapis.com/strims.chat.v1.MessageEntities.Bounds", 
        PROTO_3, 
        null
      ) {
        override fun encodedSize(value: Bounds): Int {
          var size = value.unknownFields.size
          if (value.start != 0) size += ProtoAdapter.UINT32.encodedSizeWithTag(1, value.start)
          if (value.end != 0) size += ProtoAdapter.UINT32.encodedSizeWithTag(2, value.end)
          return size
        }

        override fun encode(writer: ProtoWriter, value: Bounds) {
          if (value.start != 0) ProtoAdapter.UINT32.encodeWithTag(writer, 1, value.start)
          if (value.end != 0) ProtoAdapter.UINT32.encodeWithTag(writer, 2, value.end)
          writer.writeBytes(value.unknownFields)
        }
        ...
        override fun decode(reader: ProtoReader): Bounds {
          ...
          val unknownFields = reader.forEachTag { tag ->
            when (tag) {
              ...
              2 -> end = ProtoAdapter.UINT32.decode(reader)
              else -> reader.readUnknownField(tag)
            }
          }
          return Bounds(
  ...
  class Link(
    @field:WireField(
      tag = 1,
      adapter = "gg.strims.api.chat.v1.MessageEntities${'$'}Bounds#ADAPTER",
      label = WireField.Label.OMIT_IDENTITY
    )
    ...
    companion object {
      ...
      val ADAPTER: ProtoAdapter<Link> = object : ProtoAdapter<Link>(
        FieldEncoding.LENGTH_DELIMITED, 
        Link::class, 
        "type.googleapis.com/strims.chat.v1.MessageEntities.Link", 
        PROTO_3, 
        null
      ) {
  ...
  class Emote(
    ...
    companion object {
      ...
      val ADAPTER: ProtoAdapter<Emote> = object : ProtoAdapter<Emote>(
        FieldEncoding.LENGTH_DELIMITED, 
        Emote::class, 
        "type.googleapis.com/strims.chat.v1.MessageEntities.Emote", 
        PROTO_3, 
        null
      ) {
        override fun encodedSize(value: Emote): Int {
          ...
          if (value.combo != 0) size += ProtoAdapter.UINT32.encodedSizeWithTag(4, value.combo)
          return size
        }
        ...
        override fun encode(writer: ProtoWriter, value: Emote) {
          ...
          if (value.combo != 0) ProtoAdapter.UINT32.encodeWithTag(writer, 4, value.combo)
          writer.writeBytes(value.unknownFields)
        }
        ...
        override fun decode(reader: ProtoReader): Emote {
          ...
          val unknownFields = reader.forEachTag { tag ->
            when (tag) {
              ...
              4 -> combo = ProtoAdapter.UINT32.decode(reader)
              else -> reader.readUnknownField(tag)
            }
          }
          return Emote(
  ...
  class Nick(
    ...
    companion object {
      ...
      val ADAPTER: ProtoAdapter<Nick> = object : ProtoAdapter<Nick>(
        FieldEncoding.LENGTH_DELIMITED, 
        Nick::class, 
        "type.googleapis.com/strims.chat.v1.MessageEntities.Nick", 
        PROTO_3, 
        null
      ) {
  ...
  class Tag(
    ...
    companion object {
      ...
      val ADAPTER: ProtoAdapter<Tag> = object : ProtoAdapter<Tag>(
        FieldEncoding.LENGTH_DELIMITED, 
        Tag::class, 
        "type.googleapis.com/strims.chat.v1.MessageEntities.Tag", 
        PROTO_3, 
        null
      ) {
  ...
  class CodeBlock(
    ...
    companion object {
      ...
      val ADAPTER: ProtoAdapter<CodeBlock> = object : ProtoAdapter<CodeBlock>(
        FieldEncoding.LENGTH_DELIMITED, 
        CodeBlock::class, 
        "type.googleapis.com/strims.chat.v1.MessageEntities.CodeBlock", 
        PROTO_3, 
        null
      ) {
  ...
  class Spoiler(
    ...
    companion object {
      ...
      val ADAPTER: ProtoAdapter<Spoiler> = object : ProtoAdapter<Spoiler>(
        FieldEncoding.LENGTH_DELIMITED, 
        Spoiler::class, 
        "type.googleapis.com/strims.chat.v1.MessageEntities.Spoiler", 
        PROTO_3, 
        null
      ) {
  ...
  class GenericEntity(
    ...
    companion object {
      ...
      val ADAPTER: ProtoAdapter<GenericEntity> = object : ProtoAdapter<GenericEntity>(
        FieldEncoding.LENGTH_DELIMITED, 
        GenericEntity::class, 
        "type.googleapis.com/strims.chat.v1.MessageEntities.GenericEntity", 
        PROTO_3, 
        null
      ) {
