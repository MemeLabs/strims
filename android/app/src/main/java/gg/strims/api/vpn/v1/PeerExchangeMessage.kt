...
// Source: strims.vpn.v1.PeerExchangeMessage in vpn/v1/peer_exchange.proto
package gg.strims.api.vpn.v1
...
class PeerExchangeMessage(
  @field:WireField(
    tag = 1,
    adapter = "gg.strims.api.vpn.v1.PeerExchangeMessage${'$'}Request#ADAPTER"
  )
  val request: Request? = null,
  @field:WireField(
    tag = 2,
    adapter = "gg.strims.api.vpn.v1.PeerExchangeMessage${'$'}Response#ADAPTER"
  )
  val response: Response? = null,
  @field:WireField(
    tag = 3,
    adapter = "gg.strims.api.vpn.v1.PeerExchangeMessage${'$'}Offer#ADAPTER"
  )
  val offer: Offer? = null,
  @field:WireField(
    tag = 4,
    adapter = "gg.strims.api.vpn.v1.PeerExchangeMessage${'$'}Answer#ADAPTER"
  )
  val answer: Answer? = null,
  @field:WireField(
    tag = 5,
    adapter = "gg.strims.api.vpn.v1.PeerExchangeMessage${'$'}IceCandidate#ADAPTER",
    jsonName = "iceCandidate"
  )
  val ice_candidate: IceCandidate? = null,
  @field:WireField(
    tag = 6,
    adapter = "gg.strims.api.vpn.v1.PeerExchangeMessage${'$'}CallbackRequest#ADAPTER",
  ...
  companion object {
    ...
    val ADAPTER: ProtoAdapter<PeerExchangeMessage> = object : ProtoAdapter<PeerExchangeMessage>(
      ...
      "type.googleapis.com/strims.vpn.v1.PeerExchangeMessage", 
      PROTO_3, 
      null
    ) {
  ...
  class Request(
    ...
    companion object {
      ...
      val ADAPTER: ProtoAdapter<Request> = object : ProtoAdapter<Request>(
        FieldEncoding.LENGTH_DELIMITED, 
        Request::class, 
        "type.googleapis.com/strims.vpn.v1.PeerExchangeMessage.Request", 
        PROTO_3, 
        null
      ) {
  ...
  class Response(
    ...
    companion object {
      ...
      val ADAPTER: ProtoAdapter<Response> = object : ProtoAdapter<Response>(
        FieldEncoding.LENGTH_DELIMITED, 
        Response::class, 
        "type.googleapis.com/strims.vpn.v1.PeerExchangeMessage.Response", 
        PROTO_3, 
        null
      ) {
  ...
  class Offer(
    ...
    companion object {
      ...
      val ADAPTER: ProtoAdapter<Offer> = object : ProtoAdapter<Offer>(
        FieldEncoding.LENGTH_DELIMITED, 
        Offer::class, 
        "type.googleapis.com/strims.vpn.v1.PeerExchangeMessage.Offer", 
        PROTO_3, 
        null
      ) {
  ...
  class Answer(
    ...
    companion object {
      ...
      val ADAPTER: ProtoAdapter<Answer> = object : ProtoAdapter<Answer>(
        FieldEncoding.LENGTH_DELIMITED, 
        Answer::class, 
        "type.googleapis.com/strims.vpn.v1.PeerExchangeMessage.Answer", 
        PROTO_3, 
        null
      ) {
  ...
  class IceCandidate(
    ...
    companion object {
      ...
      val ADAPTER: ProtoAdapter<IceCandidate> = object : ProtoAdapter<IceCandidate>(
        FieldEncoding.LENGTH_DELIMITED, 
        IceCandidate::class, 
        "type.googleapis.com/strims.vpn.v1.PeerExchangeMessage.IceCandidate", 
        PROTO_3, 
        null
      ) {
  ...
  class CallbackRequest(
    ...
    companion object {
      ...
      val ADAPTER: ProtoAdapter<CallbackRequest> = object : ProtoAdapter<CallbackRequest>(
        ...
        "type.googleapis.com/strims.vpn.v1.PeerExchangeMessage.CallbackRequest", 
        PROTO_3, 
        null
      ) {
