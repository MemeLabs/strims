...
// Source: strims.chat.v1.OpenChatClientRequest in chat/v1/chat.proto
...
class OpenChatClientRequest(
...
) : Message<OpenChatClientRequest, Nothing>(ADAPTER, unknownFields) {
  @Deprecated(
  ...
  override fun equals(other: Any?): Boolean {
    ...
    if (other !is OpenChatClientRequest) return false
  ...
  override fun toString(): String {
    ...
    return result.joinToString(prefix = "OpenChatClientRequest{", separator = ", ", postfix = "}")
  }
  ...
  ): OpenChatClientRequest = OpenChatClientRequest(network_key, server_key, unknownFields)

  companion object {
    @JvmField
    val ADAPTER: ProtoAdapter<OpenChatClientRequest> = object : ProtoAdapter<OpenChatClientRequest>(
      FieldEncoding.LENGTH_DELIMITED, 
      OpenChatClientRequest::class, 
      "type.googleapis.com/strims.chat.v1.OpenChatClientRequest", 
      PROTO_3, 
      null
    ) {
      override fun encodedSize(value: OpenChatClientRequest): Int {
      ...
      override fun encode(writer: ProtoWriter, value: OpenChatClientRequest) {
      ...
      override fun decode(reader: ProtoReader): OpenChatClientRequest {
      ...
      override fun redact(value: OpenChatClientRequest): OpenChatClientRequest = value.copy(
