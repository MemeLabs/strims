...
// Source: strims.network.v1.CreateNetworkInvitationRequest in network/v1/network.proto
...
class CreateNetworkInvitationRequest(
  ...
  companion object {
    ...
    val ADAPTER: ProtoAdapter<CreateNetworkInvitationRequest> = object :
      ...
      "type.googleapis.com/strims.network.v1.CreateNetworkInvitationRequest", 
      PROTO_3, 
      null
    ) {
