...
// Source: strims.video.v1.VideoChannel in video/v1/channel.proto
...
class VideoChannel(
  ...
  @field:WireField(
    tag = 1001,
    adapter = "gg.strims.api.video.v1.VideoChannel${'$'}Local#ADAPTER"
  )
  val local: Local? = null,
  @field:WireField(
    tag = 1002,
    adapter = "gg.strims.api.video.v1.VideoChannel${'$'}LocalShare#ADAPTER",
    jsonName = "localShare"
  )
  val local_share: LocalShare? = null,
  @field:WireField(
    tag = 1003,
    adapter = "gg.strims.api.video.v1.VideoChannel${'$'}RemoteShare#ADAPTER",
  ...
  companion object {
    ...
    val ADAPTER: ProtoAdapter<VideoChannel> = object : ProtoAdapter<VideoChannel>(
      ...
      VideoChannel::class, 
      "type.googleapis.com/strims.video.v1.VideoChannel", 
      PROTO_3, 
      null
    ) {
  ...
  class Local(
    ...
    companion object {
      ...
      val ADAPTER: ProtoAdapter<Local> = object : ProtoAdapter<Local>(
        FieldEncoding.LENGTH_DELIMITED, 
        Local::class, 
        "type.googleapis.com/strims.video.v1.VideoChannel.Local", 
        PROTO_3, 
        null
      ) {
  ...
  class LocalShare(
    ...
    companion object {
      ...
      val ADAPTER: ProtoAdapter<LocalShare> = object : ProtoAdapter<LocalShare>(
        FieldEncoding.LENGTH_DELIMITED, 
        LocalShare::class, 
        "type.googleapis.com/strims.video.v1.VideoChannel.LocalShare", 
        PROTO_3, 
        null
      ) {
  ...
  class RemoteShare(
    ...
    companion object {
      ...
      val ADAPTER: ProtoAdapter<RemoteShare> = object : ProtoAdapter<RemoteShare>(
        FieldEncoding.LENGTH_DELIMITED, 
        RemoteShare::class, 
        "type.googleapis.com/strims.video.v1.VideoChannel.RemoteShare", 
        PROTO_3, 
        null
      ) {
