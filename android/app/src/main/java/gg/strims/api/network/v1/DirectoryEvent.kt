...
class DirectoryEvent(
  @field:WireField(
    tag = 1,
    adapter = "gg.strims.api.network.v1.DirectoryEvent${'$'}Publish#ADAPTER"
  )
  val publish: Publish? = null,
  @field:WireField(
    tag = 2,
    adapter = "gg.strims.api.network.v1.DirectoryEvent${'$'}Unpublish#ADAPTER"
  )
  val unpublish: Unpublish? = null,
  @field:WireField(
    tag = 3,
    adapter = "gg.strims.api.network.v1.DirectoryEvent${'$'}ViewerCountChange#ADAPTER",
    jsonName = "viewerCountChange"
  )
  val viewer_count_change: ViewerCountChange? = null,
  @field:WireField(
    tag = 4,
    adapter = "gg.strims.api.network.v1.DirectoryEvent${'$'}ViewerStateChange#ADAPTER",
    jsonName = "viewerStateChange"
  )
  val viewer_state_change: ViewerStateChange? = null,
  @field:WireField(
    tag = 5,
    adapter = "gg.strims.api.network.v1.DirectoryEvent${'$'}Ping#ADAPTER"
  )
  val ping: Ping? = null,
  @field:WireField(
    tag = 6,
    adapter = "gg.strims.api.network.v1.DirectoryEvent${'$'}Padding#ADAPTER"
  )
