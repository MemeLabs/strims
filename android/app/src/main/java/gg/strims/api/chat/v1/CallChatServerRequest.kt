...
// Source: strims.chat.v1.CallChatServerRequest in chat/v1/chat.proto
...
class CallChatServerRequest(
  ...
  @field:WireField(
    tag = 2,
    adapter = "gg.strims.api.chat.v1.CallChatServerRequest${'$'}Close#ADAPTER"
  )
  ...
  companion object {
    ...
    val ADAPTER: ProtoAdapter<CallChatServerRequest> = object : ProtoAdapter<CallChatServerRequest>(
      ...
      "type.googleapis.com/strims.chat.v1.CallChatServerRequest", 
      PROTO_3, 
      null
    ) {
  ...
  class Close(
    ...
    companion object {
      ...
      val ADAPTER: ProtoAdapter<Close> = object : ProtoAdapter<Close>(
        FieldEncoding.LENGTH_DELIMITED, 
        Close::class, 
        "type.googleapis.com/strims.chat.v1.CallChatServerRequest.Close", 
        PROTO_3, 
        null
      ) {
