...
class PeerIndexMessage(
  @field:WireField(
    tag = 1,
    adapter = "gg.strims.api.vpn.v1.PeerIndexMessage${'$'}Publish#ADAPTER"
  )
  val publish: Publish? = null,
  @field:WireField(
    tag = 2,
    adapter = "gg.strims.api.vpn.v1.PeerIndexMessage${'$'}Unpublish#ADAPTER"
  )
  val unpublish: Unpublish? = null,
  @field:WireField(
    tag = 3,
    adapter = "gg.strims.api.vpn.v1.PeerIndexMessage${'$'}SearchRequest#ADAPTER",
    jsonName = "searchRequest"
  )
  val search_request: SearchRequest? = null,
  @field:WireField(
    tag = 4,
    adapter = "gg.strims.api.vpn.v1.PeerIndexMessage${'$'}SearchResponse#ADAPTER",
  ...
  class Publish(
    @field:WireField(
      tag = 1,
      adapter = "gg.strims.api.vpn.v1.PeerIndexMessage${'$'}Record#ADAPTER",
      label = WireField.Label.OMIT_IDENTITY
    )
