...
class HashTableMessage(
  @field:WireField(
    tag = 1,
    adapter = "gg.strims.api.vpn.v1.HashTableMessage${'$'}Publish#ADAPTER"
  )
  val publish: Publish? = null,
  @field:WireField(
    tag = 2,
    adapter = "gg.strims.api.vpn.v1.HashTableMessage${'$'}Unpublish#ADAPTER"
  )
  val unpublish: Unpublish? = null,
  @field:WireField(
    tag = 3,
    adapter = "gg.strims.api.vpn.v1.HashTableMessage${'$'}GetRequest#ADAPTER",
    jsonName = "getRequest"
  )
  val get_request: GetRequest? = null,
  @field:WireField(
    tag = 4,
    adapter = "gg.strims.api.vpn.v1.HashTableMessage${'$'}GetResponse#ADAPTER",
  ...
  class Publish(
    @field:WireField(
      tag = 1,
      adapter = "gg.strims.api.vpn.v1.HashTableMessage${'$'}Record#ADAPTER",
      label = WireField.Label.OMIT_IDENTITY
    )
