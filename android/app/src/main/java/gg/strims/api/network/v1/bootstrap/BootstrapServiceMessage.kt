...
class BootstrapServiceMessage(
  @field:WireField(
    tag = 1,
    adapter = "gg.strims.api.network.v1.bootstrap.BootstrapServiceMessage${'$'}BrokerOffer#ADAPTER",
  ...
  @field:WireField(
    tag = 2,
    adapter =
        "gg.strims.api.network.v1.bootstrap.BootstrapServiceMessage${'$'}PublishRequest#ADAPTER",
  ...
  @field:WireField(
    tag = 3,
    adapter =
        "gg.strims.api.network.v1.bootstrap.BootstrapServiceMessage${'$'}PublishResponse#ADAPTER",
