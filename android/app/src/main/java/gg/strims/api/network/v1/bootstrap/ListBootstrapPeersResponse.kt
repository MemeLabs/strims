...
// Source: strims.network.v1.bootstrap.ListBootstrapPeersResponse in network/v1/bootstrap/bootstrap.proto
...
class ListBootstrapPeersResponse(
  ...
  @field:WireField(
    tag = 1,
    adapter = "gg.strims.api.network.v1.bootstrap.BootstrapPeer#ADAPTER",
  ...
  companion object {
    ...
    val ADAPTER: ProtoAdapter<ListBootstrapPeersResponse> = object :
      ...
      "type.googleapis.com/strims.network.v1.bootstrap.ListBootstrapPeersResponse", 
      PROTO_3, 
      null
    ) {
