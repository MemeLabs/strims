...
// Source: strims.network.v1.ca.CAPeerRenewRequest in network/v1/ca/peer.proto
...
import gg.strims.api.type.CertificateRequest
import kotlin.Any
...
class CAPeerRenewRequest(
  ...
  @field:WireField(
    tag = 2,
    adapter = "gg.strims.api.type.CertificateRequest#ADAPTER",
    label = WireField.Label.OMIT_IDENTITY,
    jsonName = "certificateRequest"
  )
  val certificate_request: CertificateRequest? = null,
  unknownFields: ByteString = ByteString.EMPTY
) : Message<CAPeerRenewRequest, Nothing>(ADAPTER, unknownFields) {
  @Deprecated(
  ...
  override fun equals(other: Any?): Boolean {
    ...
    if (other !is CAPeerRenewRequest) return false
  ...
  override fun toString(): String {
    ...
    return result.joinToString(prefix = "CAPeerRenewRequest{", separator = ", ", postfix = "}")
  }
  ...
  ): CAPeerRenewRequest = CAPeerRenewRequest(certificate, certificate_request, unknownFields)

  companion object {
    @JvmField
    val ADAPTER: ProtoAdapter<CAPeerRenewRequest> = object : ProtoAdapter<CAPeerRenewRequest>(
      FieldEncoding.LENGTH_DELIMITED, 
      CAPeerRenewRequest::class, 
      "type.googleapis.com/strims.network.v1.ca.CAPeerRenewRequest", 
      PROTO_3, 
      null
    ) {
      override fun encodedSize(value: CAPeerRenewRequest): Int {
      ...
      override fun encode(writer: ProtoWriter, value: CAPeerRenewRequest) {
      ...
      override fun decode(reader: ProtoReader): CAPeerRenewRequest {
      ...
      override fun redact(value: CAPeerRenewRequest): CAPeerRenewRequest = value.copy(
