...
// Source: BootstrapServiceMessage in vpn.proto
...
class BootstrapServiceMessage(
  @field:WireField(
    tag = 1,
    adapter = "gg.strims.ppspp.proto.BootstrapServiceMessage${'$'}BrokerOffer#ADAPTER",
    jsonName = "brokerOffer"
  )
  val broker_offer: BrokerOffer? = null,
  @field:WireField(
    tag = 2,
    adapter = "gg.strims.ppspp.proto.BootstrapServiceMessage${'$'}PublishRequest#ADAPTER",
    jsonName = "publishRequest"
  )
  val publish_request: PublishRequest? = null,
  @field:WireField(
    tag = 3,
    adapter = "gg.strims.ppspp.proto.BootstrapServiceMessage${'$'}PublishResponse#ADAPTER",
  ...
  companion object {
    ...
    val ADAPTER: ProtoAdapter<BootstrapServiceMessage> = object :
      ...
      "type.googleapis.com/BootstrapServiceMessage", 
      PROTO_3, 
      null
    ) {
  ...
  class BrokerOffer(
    ...
    companion object {
      ...
      val ADAPTER: ProtoAdapter<BrokerOffer> = object : ProtoAdapter<BrokerOffer>(
        FieldEncoding.LENGTH_DELIMITED, 
        BrokerOffer::class, 
        "type.googleapis.com/BootstrapServiceMessage.BrokerOffer", 
        PROTO_3, 
        null
      ) {
  ...
  class PublishRequest(
    ...
    companion object {
      ...
      val ADAPTER: ProtoAdapter<PublishRequest> = object : ProtoAdapter<PublishRequest>(
        ...
        "type.googleapis.com/BootstrapServiceMessage.PublishRequest", 
        PROTO_3, 
        null
      ) {
  ...
  class PublishResponse(
    ...
    companion object {
      ...
      val ADAPTER: ProtoAdapter<PublishResponse> = object : ProtoAdapter<PublishResponse>(
        ...
        "type.googleapis.com/BootstrapServiceMessage.PublishResponse", 
        PROTO_3, 
        null
      ) {
