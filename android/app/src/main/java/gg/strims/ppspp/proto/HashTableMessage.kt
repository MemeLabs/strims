...
// Source: HashTableMessage in hash_table.proto
...
class HashTableMessage(
  @field:WireField(
    tag = 1,
    adapter = "gg.strims.ppspp.proto.HashTableMessage${'$'}Publish#ADAPTER"
  )
  val publish: Publish? = null,
  @field:WireField(
    tag = 2,
    adapter = "gg.strims.ppspp.proto.HashTableMessage${'$'}Unpublish#ADAPTER"
  )
  val unpublish: Unpublish? = null,
  @field:WireField(
    tag = 3,
    adapter = "gg.strims.ppspp.proto.HashTableMessage${'$'}GetRequest#ADAPTER",
    jsonName = "getRequest"
  )
  val get_request: GetRequest? = null,
  @field:WireField(
    tag = 4,
    adapter = "gg.strims.ppspp.proto.HashTableMessage${'$'}GetResponse#ADAPTER",
  ...
  companion object {
    ...
    val ADAPTER: ProtoAdapter<HashTableMessage> = object : ProtoAdapter<HashTableMessage>(
      ...
      "type.googleapis.com/HashTableMessage", 
      PROTO_3, 
      null
    ) {
  ...
  class Record(
    ...
    companion object {
      ...
      val ADAPTER: ProtoAdapter<Record> = object : ProtoAdapter<Record>(
        FieldEncoding.LENGTH_DELIMITED, 
        Record::class, 
        "type.googleapis.com/HashTableMessage.Record", 
        PROTO_3, 
        null
      ) {
  ...
  class Publish(
    @field:WireField(
      tag = 1,
      adapter = "gg.strims.ppspp.proto.HashTableMessage${'$'}Record#ADAPTER",
      label = WireField.Label.OMIT_IDENTITY
    )
    ...
    companion object {
      ...
      val ADAPTER: ProtoAdapter<Publish> = object : ProtoAdapter<Publish>(
        FieldEncoding.LENGTH_DELIMITED, 
        Publish::class, 
        "type.googleapis.com/HashTableMessage.Publish", 
        PROTO_3, 
        null
      ) {
  ...
  class Unpublish(
    ...
    companion object {
      ...
      val ADAPTER: ProtoAdapter<Unpublish> = object : ProtoAdapter<Unpublish>(
        FieldEncoding.LENGTH_DELIMITED, 
        Unpublish::class, 
        "type.googleapis.com/HashTableMessage.Unpublish", 
        PROTO_3, 
        null
      ) {
  ...
  class GetRequest(
    ...
    companion object {
      ...
      val ADAPTER: ProtoAdapter<GetRequest> = object : ProtoAdapter<GetRequest>(
        FieldEncoding.LENGTH_DELIMITED, 
        GetRequest::class, 
        "type.googleapis.com/HashTableMessage.GetRequest", 
        PROTO_3, 
        null
      ) {
  ...
  class GetResponse(
    ...
    companion object {
      ...
      val ADAPTER: ProtoAdapter<GetResponse> = object : ProtoAdapter<GetResponse>(
        FieldEncoding.LENGTH_DELIMITED, 
        GetResponse::class, 
        "type.googleapis.com/HashTableMessage.GetResponse", 
        PROTO_3, 
        null
      ) {
