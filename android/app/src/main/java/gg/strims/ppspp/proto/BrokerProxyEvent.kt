...
// Source: BrokerProxyEvent in vpn.proto
...
class BrokerProxyEvent(
  @field:WireField(
    tag = 1,
    adapter = "gg.strims.ppspp.proto.BrokerProxyEvent${'$'}Open#ADAPTER"
  )
  val open: Open? = null,
  @field:WireField(
    tag = 2,
    adapter = "gg.strims.ppspp.proto.BrokerProxyEvent${'$'}Data#ADAPTER"
  )
  val data: Data? = null,
  @field:WireField(
    tag = 3,
    adapter = "gg.strims.ppspp.proto.BrokerProxyEvent${'$'}Read#ADAPTER"
  )
  val read: Read? = null,
  ...
  companion object {
    ...
    val ADAPTER: ProtoAdapter<BrokerProxyEvent> = object : ProtoAdapter<BrokerProxyEvent>(
      ...
      "type.googleapis.com/BrokerProxyEvent", 
      PROTO_3, 
      null
    ) {
  ...
  class Open(
    ...
    companion object {
      ...
      val ADAPTER: ProtoAdapter<Open> = object : ProtoAdapter<Open>(
        FieldEncoding.LENGTH_DELIMITED, 
        Open::class, 
        "type.googleapis.com/BrokerProxyEvent.Open", 
        PROTO_3, 
        null
      ) {
  ...
  class Data(
    ...
    companion object {
      ...
      val ADAPTER: ProtoAdapter<Data> = object : ProtoAdapter<Data>(
        FieldEncoding.LENGTH_DELIMITED, 
        Data::class, 
        "type.googleapis.com/BrokerProxyEvent.Data", 
        PROTO_3, 
        null
      ) {
  ...
  class Read(
    ...
    companion object {
      ...
      val ADAPTER: ProtoAdapter<Read> = object : ProtoAdapter<Read>(
        FieldEncoding.LENGTH_DELIMITED, 
        Read::class, 
        "type.googleapis.com/BrokerProxyEvent.Read", 
        PROTO_3, 
        null
      ) {
