...
// Source: PeerIndexMessage in peer_index.proto
...
class PeerIndexMessage(
  @field:WireField(
    tag = 1,
    adapter = "gg.strims.ppspp.proto.PeerIndexMessage${'$'}Publish#ADAPTER"
  )
  val publish: Publish? = null,
  @field:WireField(
    tag = 2,
    adapter = "gg.strims.ppspp.proto.PeerIndexMessage${'$'}Unpublish#ADAPTER"
  )
  val unpublish: Unpublish? = null,
  @field:WireField(
    tag = 3,
    adapter = "gg.strims.ppspp.proto.PeerIndexMessage${'$'}SearchRequest#ADAPTER",
    jsonName = "searchRequest"
  )
  val search_request: SearchRequest? = null,
  @field:WireField(
    tag = 4,
    adapter = "gg.strims.ppspp.proto.PeerIndexMessage${'$'}SearchResponse#ADAPTER",
  ...
  companion object {
    ...
    val ADAPTER: ProtoAdapter<PeerIndexMessage> = object : ProtoAdapter<PeerIndexMessage>(
      ...
      "type.googleapis.com/PeerIndexMessage", 
      PROTO_3, 
      null
    ) {
  ...
  class Record(
    ...
    companion object {
      ...
      val ADAPTER: ProtoAdapter<Record> = object : ProtoAdapter<Record>(
        FieldEncoding.LENGTH_DELIMITED, 
        Record::class, 
        "type.googleapis.com/PeerIndexMessage.Record", 
        PROTO_3, 
        null
      ) {
  ...
  class Publish(
    @field:WireField(
      tag = 1,
      adapter = "gg.strims.ppspp.proto.PeerIndexMessage${'$'}Record#ADAPTER",
      label = WireField.Label.OMIT_IDENTITY
    )
    ...
    companion object {
      ...
      val ADAPTER: ProtoAdapter<Publish> = object : ProtoAdapter<Publish>(
        FieldEncoding.LENGTH_DELIMITED, 
        Publish::class, 
        "type.googleapis.com/PeerIndexMessage.Publish", 
        PROTO_3, 
        null
      ) {
  ...
  class Unpublish(
    ...
    companion object {
      ...
      val ADAPTER: ProtoAdapter<Unpublish> = object : ProtoAdapter<Unpublish>(
        FieldEncoding.LENGTH_DELIMITED, 
        Unpublish::class, 
        "type.googleapis.com/PeerIndexMessage.Unpublish", 
        PROTO_3, 
        null
      ) {
  ...
  class SearchRequest(
    ...
    companion object {
      ...
      val ADAPTER: ProtoAdapter<SearchRequest> = object : ProtoAdapter<SearchRequest>(
        FieldEncoding.LENGTH_DELIMITED, 
        SearchRequest::class, 
        "type.googleapis.com/PeerIndexMessage.SearchRequest", 
        PROTO_3, 
        null
      ) {
  ...
  class SearchResponse(
    ...
    companion object {
      ...
      val ADAPTER: ProtoAdapter<SearchResponse> = object : ProtoAdapter<SearchResponse>(
        ...
        "type.googleapis.com/PeerIndexMessage.SearchResponse", 
        PROTO_3, 
        null
      ) {
