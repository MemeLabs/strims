...
func (x *ConfigDeleteEvent) Reset() {
	*x = ConfigDeleteEvent{}
	if protoimpl.UnsafeEnabled {
		mi := &file_vnic_v1_events_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *ConfigDeleteEvent) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ConfigDeleteEvent) ProtoMessage() {}

func (x *ConfigDeleteEvent) ProtoReflect() protoreflect.Message {
	mi := &file_vnic_v1_events_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ConfigDeleteEvent.ProtoReflect.Descriptor instead.
func (*ConfigDeleteEvent) Descriptor() ([]byte, []int) {
	return file_vnic_v1_events_proto_rawDescGZIP(), []int{1}
}

func (x *ConfigDeleteEvent) GetConfig() *Config {
	if x != nil {
		return x.Config
	}
	return nil
...
var file_vnic_v1_events_proto_rawDesc = []byte{
	...
	0x43, 0x0a, 0x11, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x45,
	0x76, 0x65, 0x6e, 0x74, 0x12, 0x2e, 0x0a, 0x06, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x16, 0x2e, 0x73, 0x74, 0x72, 0x69, 0x6d, 0x73, 0x2e, 0x76, 0x6e,
	0x69, 0x63, 0x2e, 0x76, 0x31, 0x2e, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x52, 0x06, 0x63, 0x6f,
	0x6e, 0x66, 0x69, 0x67, 0x42, 0x4f, 0x0a, 0x11, 0x67, 0x67, 0x2e, 0x73, 0x74, 0x72, 0x69, 0x6d,
...
var file_vnic_v1_events_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_vnic_v1_events_proto_goTypes = []interface{}{
	(*ConfigChangeEvent)(nil), // 0: strims.vnic.v1.ConfigChangeEvent
	(*ConfigDeleteEvent)(nil), // 1: strims.vnic.v1.ConfigDeleteEvent
	(*Config)(nil),            // 2: strims.vnic.v1.Config
}
var file_vnic_v1_events_proto_depIdxs = []int32{
	2, // 0: strims.vnic.v1.ConfigChangeEvent.config:type_name -> strims.vnic.v1.Config
	2, // 1: strims.vnic.v1.ConfigDeleteEvent.config:type_name -> strims.vnic.v1.Config
...
func file_vnic_v1_events_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_vnic_v1_events_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ConfigDeleteEvent); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
