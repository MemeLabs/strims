...
var file_network_v1_directory_directory_proto_msgTypes = make([]protoimpl.MessageInfo, 41)
var file_network_v1_directory_directory_proto_goTypes = []interface{}{
	...
	(*ListingSnippetDelta_Tags)(nil),             // 35: strims.network.v1.directory.ListingSnippetDelta.Tags
	(*Event_ListingChange)(nil),                  // 36: strims.network.v1.directory.Event.ListingChange
	(*Event_Unpublish)(nil),                      // 37: strims.network.v1.directory.Event.Unpublish
	(*Event_ViewerCountChange)(nil),              // 38: strims.network.v1.directory.Event.ViewerCountChange
	(*Event_ViewerStateChange)(nil),              // 39: strims.network.v1.directory.Event.ViewerStateChange
	(*Event_Ping)(nil),                           // 40: strims.network.v1.directory.Event.Ping
	(*FrontendOpenResponse_Close)(nil),           // 41: strims.network.v1.directory.FrontendOpenResponse.Close
	(*image.Image)(nil),                          // 42: strims.type.Image
...
var file_network_v1_directory_directory_proto_depIdxs = []int32{
	...
	42, // 4: strims.network.v1.directory.ListingSnippetImage.image:type_name -> strims.type.Image
	6,  // 5: strims.network.v1.directory.ListingSnippet.thumbnail:type_name -> strims.network.v1.directory.ListingSnippetImage
	6,  // 6: strims.network.v1.directory.ListingSnippet.channel_logo:type_name -> strims.network.v1.directory.ListingSnippetImage
	43, // 7: strims.network.v1.directory.ListingSnippetDelta.title:type_name -> google.protobuf.StringValue
	43, // 8: strims.network.v1.directory.ListingSnippetDelta.description:type_name -> google.protobuf.StringValue
	43, // 9: strims.network.v1.directory.ListingSnippetDelta.category:type_name -> google.protobuf.StringValue
	43, // 10: strims.network.v1.directory.ListingSnippetDelta.channel_name:type_name -> google.protobuf.StringValue
	44, // 11: strims.network.v1.directory.ListingSnippetDelta.viewer_count:type_name -> google.protobuf.UInt64Value
	45, // 12: strims.network.v1.directory.ListingSnippetDelta.live:type_name -> google.protobuf.BoolValue
	45, // 13: strims.network.v1.directory.ListingSnippetDelta.is_mature:type_name -> google.protobuf.BoolValue
	46, // 14: strims.network.v1.directory.ListingSnippetDelta.key:type_name -> google.protobuf.BytesValue
	46, // 15: strims.network.v1.directory.ListingSnippetDelta.signature:type_name -> google.protobuf.BytesValue
	35, // 16: strims.network.v1.directory.ListingSnippetDelta.tags:type_name -> strims.network.v1.directory.ListingSnippetDelta.Tags
	6,  // 17: strims.network.v1.directory.ListingSnippetDelta.thumbnail:type_name -> strims.network.v1.directory.ListingSnippetImage
	6,  // 18: strims.network.v1.directory.ListingSnippetDelta.channel_logo:type_name -> strims.network.v1.directory.ListingSnippetImage
	36, // 19: strims.network.v1.directory.Event.listing_change:type_name -> strims.network.v1.directory.Event.ListingChange
	37, // 20: strims.network.v1.directory.Event.unpublish:type_name -> strims.network.v1.directory.Event.Unpublish
	38, // 21: strims.network.v1.directory.Event.viewer_count_change:type_name -> strims.network.v1.directory.Event.ViewerCountChange
	39, // 22: strims.network.v1.directory.Event.viewer_state_change:type_name -> strims.network.v1.directory.Event.ViewerStateChange
	40, // 23: strims.network.v1.directory.Event.ping:type_name -> strims.network.v1.directory.Event.Ping
	9,  // 24: strims.network.v1.directory.EventBroadcast.events:type_name -> strims.network.v1.directory.Event
	5,  // 25: strims.network.v1.directory.PublishRequest.listing:type_name -> strims.network.v1.directory.Listing
	41, // 26: strims.network.v1.directory.FrontendOpenResponse.close:type_name -> strims.network.v1.directory.FrontendOpenResponse.Close
	10, // 27: strims.network.v1.directory.FrontendOpenResponse.broadcast:type_name -> strims.network.v1.directory.EventBroadcast
	8,  // 28: strims.network.v1.directory.SnippetSubscribeResponse.snippet_delta:type_name -> strims.network.v1.directory.ListingSnippetDelta
	28, // 29: strims.network.v1.directory.ServerConfig.Integrations.angelthump:type_name -> strims.network.v1.directory.ServerConfig.Integrations.AngelThump
	29, // 30: strims.network.v1.directory.ServerConfig.Integrations.twitch:type_name -> strims.network.v1.directory.ServerConfig.Integrations.Twitch
	30, // 31: strims.network.v1.directory.ServerConfig.Integrations.youtube:type_name -> strims.network.v1.directory.ServerConfig.Integrations.YouTube
	31, // 32: strims.network.v1.directory.ServerConfig.Integrations.swarm:type_name -> strims.network.v1.directory.ServerConfig.Integrations.Swarm
	0,  // 33: strims.network.v1.directory.Listing.Embed.service:type_name -> strims.network.v1.directory.Listing.Embed.Service
	5,  // 34: strims.network.v1.directory.Event.ListingChange.listing:type_name -> strims.network.v1.directory.Listing
	7,  // 35: strims.network.v1.directory.Event.ListingChange.snippet:type_name -> strims.network.v1.directory.ListingSnippet
	11, // 36: strims.network.v1.directory.Directory.Publish:input_type -> strims.network.v1.directory.PublishRequest
	13, // 37: strims.network.v1.directory.Directory.Unpublish:input_type -> strims.network.v1.directory.UnpublishRequest
	15, // 38: strims.network.v1.directory.Directory.Join:input_type -> strims.network.v1.directory.JoinRequest
	17, // 39: strims.network.v1.directory.Directory.Part:input_type -> strims.network.v1.directory.PartRequest
	19, // 40: strims.network.v1.directory.Directory.Ping:input_type -> strims.network.v1.directory.PingRequest
	21, // 41: strims.network.v1.directory.DirectoryFrontend.Open:input_type -> strims.network.v1.directory.FrontendOpenRequest
	23, // 42: strims.network.v1.directory.DirectoryFrontend.Test:input_type -> strims.network.v1.directory.FrontendTestRequest
	25, // 43: strims.network.v1.directory.DirectorySnippet.Subscribe:input_type -> strims.network.v1.directory.SnippetSubscribeRequest
	12, // 44: strims.network.v1.directory.Directory.Publish:output_type -> strims.network.v1.directory.PublishResponse
	14, // 45: strims.network.v1.directory.Directory.Unpublish:output_type -> strims.network.v1.directory.UnpublishResponse
	16, // 46: strims.network.v1.directory.Directory.Join:output_type -> strims.network.v1.directory.JoinResponse
	18, // 47: strims.network.v1.directory.Directory.Part:output_type -> strims.network.v1.directory.PartResponse
	20, // 48: strims.network.v1.directory.Directory.Ping:output_type -> strims.network.v1.directory.PingResponse
	22, // 49: strims.network.v1.directory.DirectoryFrontend.Open:output_type -> strims.network.v1.directory.FrontendOpenResponse
	24, // 50: strims.network.v1.directory.DirectoryFrontend.Test:output_type -> strims.network.v1.directory.FrontendTestResponse
	26, // 51: strims.network.v1.directory.DirectorySnippet.Subscribe:output_type -> strims.network.v1.directory.SnippetSubscribeResponse
