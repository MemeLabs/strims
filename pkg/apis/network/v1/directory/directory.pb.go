...
var file_network_v1_directory_directory_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x65, 0x6f, 0x66, 0x22, 0x8a, 0x04, 0x0a, 0x0e, 0x4c, 0x69, 0x73, 0x74, 0x69, 0x6e,
	...
	0x12, 0x11, 0x0a, 0x03, 0x6b, 0x65, 0x79, 0x18, 0x91, 0x4e, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x03,
	0x6b, 0x65, 0x79, 0x12, 0x1d, 0x0a, 0x09, 0x73, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65,
	0x18, 0x92, 0x4e, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x09, 0x73, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75,
	0x72, 0x65, 0x22, 0xe5, 0x07, 0x0a, 0x13, 0x4c, 0x69, 0x73, 0x74, 0x69, 0x6e, 0x67, 0x53, 0x6e,
	0x69, 0x70, 0x70, 0x65, 0x74, 0x44, 0x65, 0x6c, 0x74, 0x61, 0x12, 0x32, 0x0a, 0x05, 0x74, 0x69,
	...
	0x66, 0x2e, 0x55, 0x49, 0x6e, 0x74, 0x36, 0x34, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x52, 0x0b, 0x76,
	...
	0x75, 0x72, 0x65, 0x12, 0x2d, 0x0a, 0x03, 0x6b, 0x65, 0x79, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0b,
	0x32, 0x1b, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62,
	0x75, 0x66, 0x2e, 0x42, 0x79, 0x74, 0x65, 0x73, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x52, 0x03, 0x6b,
	0x65, 0x79, 0x12, 0x39, 0x0a, 0x09, 0x73, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x18,
	...
	,
...
var file_network_v1_directory_directory_proto_depIdxs = []int32{
	...
	55, // 20: strims.network.v1.directory.ListingSnippetDelta.tags:type_name -> strims.network.v1.directory.ListingSnippetDelta.Tags
	7,  // 21: strims.network.v1.directory.ListingSnippetDelta.thumbnail:type_name -> strims.network.v1.directory.ListingSnippetImage
	7,  // 22: strims.network.v1.directory.ListingSnippetDelta.channel_logo:type_name -> strims.network.v1.directory.ListingSnippetImage
	56, // 23: strims.network.v1.directory.Event.listing_change:type_name -> strims.network.v1.directory.Event.ListingChange
	57, // 24: strims.network.v1.directory.Event.unpublish:type_name -> strims.network.v1.directory.Event.Unpublish
	58, // 25: strims.network.v1.directory.Event.viewer_count_change:type_name -> strims.network.v1.directory.Event.ViewerCountChange
	59, // 26: strims.network.v1.directory.Event.viewer_state_change:type_name -> strims.network.v1.directory.Event.ViewerStateChange
	60, // 27: strims.network.v1.directory.Event.ping:type_name -> strims.network.v1.directory.Event.Ping
	6,  // 28: strims.network.v1.directory.ListingRecord.listing:type_name -> strims.network.v1.directory.Listing
	11, // 29: strims.network.v1.directory.ListingRecord.moderation:type_name -> strims.network.v1.directory.ListingModeration
	10, // 30: strims.network.v1.directory.EventBroadcast.events:type_name -> strims.network.v1.directory.Event
	6,  // 31: strims.network.v1.directory.PublishRequest.listing:type_name -> strims.network.v1.directory.Listing
	61, // 32: strims.network.v1.directory.FrontendOpenResponse.close:type_name -> strims.network.v1.directory.FrontendOpenResponse.Close
	13, // 33: strims.network.v1.directory.FrontendOpenResponse.broadcast:type_name -> strims.network.v1.directory.EventBroadcast
	6,  // 34: strims.network.v1.directory.FrontendPublishRequest.listing:type_name -> strims.network.v1.directory.Listing
	12, // 35: strims.network.v1.directory.FrontendGetListingRecordResponse.record:type_name -> strims.network.v1.directory.ListingRecord
	12, // 36: strims.network.v1.directory.FrontendListListingRecordsResponse.records:type_name -> strims.network.v1.directory.ListingRecord
	11, // 37: strims.network.v1.directory.FrontendUpdateListingRecordRequest.moderation:type_name -> strims.network.v1.directory.ListingModeration
	12, // 38: strims.network.v1.directory.FrontendUpdateListingRecordResponse.record:type_name -> strims.network.v1.directory.ListingRecord
	9,  // 39: strims.network.v1.directory.SnippetSubscribeResponse.snippet_delta:type_name -> strims.network.v1.directory.ListingSnippetDelta
	45, // 40: strims.network.v1.directory.ServerConfig.Integrations.angelthump:type_name -> strims.network.v1.directory.ServerConfig.Integrations.AngelThump
	46, // 41: strims.network.v1.directory.ServerConfig.Integrations.twitch:type_name -> strims.network.v1.directory.ServerConfig.Integrations.Twitch
	47, // 42: strims.network.v1.directory.ServerConfig.Integrations.youtube:type_name -> strims.network.v1.directory.ServerConfig.Integrations.YouTube
	48, // 43: strims.network.v1.directory.ServerConfig.Integrations.swarm:type_name -> strims.network.v1.directory.ServerConfig.Integrations.Swarm
	0,  // 44: strims.network.v1.directory.Listing.Embed.service:type_name -> strims.network.v1.directory.Listing.Embed.Service
	54, // 45: strims.network.v1.directory.Listing.Embed.query_params:type_name -> strims.network.v1.directory.Listing.Embed.QueryParamsEntry
	6,  // 46: strims.network.v1.directory.Event.ListingChange.listing:type_name -> strims.network.v1.directory.Listing
	8,  // 47: strims.network.v1.directory.Event.ListingChange.snippet:type_name -> strims.network.v1.directory.ListingSnippet
	11, // 48: strims.network.v1.directory.Event.ListingChange.moderation:type_name -> strims.network.v1.directory.ListingModeration
	14, // 49: strims.network.v1.directory.Directory.Publish:input_type -> strims.network.v1.directory.PublishRequest
	16, // 50: strims.network.v1.directory.Directory.Unpublish:input_type -> strims.network.v1.directory.UnpublishRequest
	18, // 51: strims.network.v1.directory.Directory.Join:input_type -> strims.network.v1.directory.JoinRequest
	20, // 52: strims.network.v1.directory.Directory.Part:input_type -> strims.network.v1.directory.PartRequest
	22, // 53: strims.network.v1.directory.Directory.Ping:input_type -> strims.network.v1.directory.PingRequest
	24, // 54: strims.network.v1.directory.DirectoryFrontend.Open:input_type -> strims.network.v1.directory.FrontendOpenRequest
	26, // 55: strims.network.v1.directory.DirectoryFrontend.Publish:input_type -> strims.network.v1.directory.FrontendPublishRequest
	28, // 56: strims.network.v1.directory.DirectoryFrontend.Unpublish:input_type -> strims.network.v1.directory.FrontendUnpublishRequest
	30, // 57: strims.network.v1.directory.DirectoryFrontend.Join:input_type -> strims.network.v1.directory.FrontendJoinRequest
	32, // 58: strims.network.v1.directory.DirectoryFrontend.Part:input_type -> strims.network.v1.directory.FrontendPartRequest
	34, // 59: strims.network.v1.directory.DirectoryFrontend.Test:input_type -> strims.network.v1.directory.FrontendTestRequest
	36, // 60: strims.network.v1.directory.DirectoryFrontend.GetListingRecord:input_type -> strims.network.v1.directory.FrontendGetListingRecordRequest
	38, // 61: strims.network.v1.directory.DirectoryFrontend.ListListingRecords:input_type -> strims.network.v1.directory.FrontendListListingRecordsRequest
	40, // 62: strims.network.v1.directory.DirectoryFrontend.UpdateListingRecord:input_type -> strims.network.v1.directory.FrontendUpdateListingRecordRequest
	42, // 63: strims.network.v1.directory.DirectorySnippet.Subscribe:input_type -> strims.network.v1.directory.SnippetSubscribeRequest
	15, // 64: strims.network.v1.directory.Directory.Publish:output_type -> strims.network.v1.directory.PublishResponse
	17, // 65: strims.network.v1.directory.Directory.Unpublish:output_type -> strims.network.v1.directory.UnpublishResponse
	19, // 66: strims.network.v1.directory.Directory.Join:output_type -> strims.network.v1.directory.JoinResponse
	21, // 67: strims.network.v1.directory.Directory.Part:output_type -> strims.network.v1.directory.PartResponse
	23, // 68: strims.network.v1.directory.Directory.Ping:output_type -> strims.network.v1.directory.PingResponse
	25, // 69: strims.network.v1.directory.DirectoryFrontend.Open:output_type -> strims.network.v1.directory.FrontendOpenResponse
	27, // 70: strims.network.v1.directory.DirectoryFrontend.Publish:output_type -> strims.network.v1.directory.FrontendPublishResponse
	29, // 71: strims.network.v1.directory.DirectoryFrontend.Unpublish:output_type -> strims.network.v1.directory.FrontendUnpublishResponse
	31, // 72: strims.network.v1.directory.DirectoryFrontend.Join:output_type -> strims.network.v1.directory.FrontendJoinResponse
	33, // 73: strims.network.v1.directory.DirectoryFrontend.Part:output_type -> strims.network.v1.directory.FrontendPartResponse
	35, // 74: strims.network.v1.directory.DirectoryFrontend.Test:output_type -> strims.network.v1.directory.FrontendTestResponse
	37, // 75: strims.network.v1.directory.DirectoryFrontend.GetListingRecord:output_type -> strims.network.v1.directory.FrontendGetListingRecordResponse
	39, // 76: strims.network.v1.directory.DirectoryFrontend.ListListingRecords:output_type -> strims.network.v1.directory.FrontendListListingRecordsResponse
	41, // 77: strims.network.v1.directory.DirectoryFrontend.UpdateListingRecord:output_type -> strims.network.v1.directory.FrontendUpdateListingRecordResponse
	43, // 78: strims.network.v1.directory.DirectorySnippet.Subscribe:output_type -> strims.network.v1.directory.SnippetSubscribeResponse
