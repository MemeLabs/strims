...
// 	protoc        v3.12.1
// source: network/v1/peer_exchange.proto
...
func (x *PeerExchangeMessage) Reset() {
	*x = PeerExchangeMessage{}
	if protoimpl.UnsafeEnabled {
		mi := &file_network_v1_peer_exchange_proto_msgTypes[0]
...
func (*PeerExchangeMessage) Descriptor() ([]byte, []int) {
	return file_network_v1_peer_exchange_proto_rawDescGZIP(), []int{0}
}
...
func (x *PeerExchangeMessage_Request) Reset() {
	*x = PeerExchangeMessage_Request{}
	if protoimpl.UnsafeEnabled {
		mi := &file_network_v1_peer_exchange_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*PeerExchangeMessage_Request) Descriptor() ([]byte, []int) {
	return file_network_v1_peer_exchange_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *PeerExchangeMessage_Response) Reset() {
	*x = PeerExchangeMessage_Response{}
	if protoimpl.UnsafeEnabled {
		mi := &file_network_v1_peer_exchange_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*PeerExchangeMessage_Response) Descriptor() ([]byte, []int) {
	return file_network_v1_peer_exchange_proto_rawDescGZIP(), []int{0, 1}
}
...
func (x *PeerExchangeMessage_Offer) Reset() {
	*x = PeerExchangeMessage_Offer{}
	if protoimpl.UnsafeEnabled {
		mi := &file_network_v1_peer_exchange_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*PeerExchangeMessage_Offer) Descriptor() ([]byte, []int) {
	return file_network_v1_peer_exchange_proto_rawDescGZIP(), []int{0, 2}
}
...
func (x *PeerExchangeMessage_Answer) Reset() {
	*x = PeerExchangeMessage_Answer{}
	if protoimpl.UnsafeEnabled {
		mi := &file_network_v1_peer_exchange_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*PeerExchangeMessage_Answer) Descriptor() ([]byte, []int) {
	return file_network_v1_peer_exchange_proto_rawDescGZIP(), []int{0, 3}
}
...
func (x *PeerExchangeMessage_IceCandidate) Reset() {
	*x = PeerExchangeMessage_IceCandidate{}
	if protoimpl.UnsafeEnabled {
		mi := &file_network_v1_peer_exchange_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*PeerExchangeMessage_IceCandidate) Descriptor() ([]byte, []int) {
	return file_network_v1_peer_exchange_proto_rawDescGZIP(), []int{0, 4}
}
...
func (x *PeerExchangeMessage_CallbackRequest) Reset() {
	*x = PeerExchangeMessage_CallbackRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_network_v1_peer_exchange_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*PeerExchangeMessage_CallbackRequest) Descriptor() ([]byte, []int) {
	return file_network_v1_peer_exchange_proto_rawDescGZIP(), []int{0, 5}
}

var File_network_v1_peer_exchange_proto protoreflect.FileDescriptor

var file_network_v1_peer_exchange_proto_rawDesc = []byte{
	0x0a, 0x1e, 0x6e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x2f, 0x76, 0x31, 0x2f, 0x70, 0x65, 0x65,
	0x72, 0x5f, 0x65, 0x78, 0x63, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x12, 0x11, 0x73, 0x74, 0x72, 0x69, 0x6d, 0x73, 0x2e, 0x6e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b,
	0x2e, 0x76, 0x31, 0x22, 0xb8, 0x06, 0x0a, 0x13, 0x50, 0x65, 0x65, 0x72, 0x45, 0x78, 0x63, 0x68,
	0x61, 0x6e, 0x67, 0x65, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x12, 0x4a, 0x0a, 0x07, 0x72,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2e, 0x2e, 0x73,
	...
	0x6e, 0x73, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2f, 0x2e, 0x73, 0x74, 0x72, 0x69,
	0x6d, 0x73, 0x2e, 0x6e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x2e, 0x76, 0x31, 0x2e, 0x50, 0x65,
	...
	,
	...
	0x65, 0x12, 0x63, 0x0a, 0x10, 0x63, 0x61, 0x6c, 0x6c, 0x62, 0x61, 0x63, 0x6b, 0x5f, 0x72, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x36, 0x2e, 0x73, 0x74,
	...
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x42, 0x06, 0x0a, 0x04, 0x62, 0x6f, 0x64, 0x79, 0x42, 0x56,
	...
	0x70, 0x73, 0x70, 0x70, 0x2f, 0x70, 0x6b, 0x67, 0x2f, 0x61, 0x70, 0x69, 0x73, 0x2f, 0x6e, 0x65,
...
var (
	file_network_v1_peer_exchange_proto_rawDescOnce sync.Once
	file_network_v1_peer_exchange_proto_rawDescData = file_network_v1_peer_exchange_proto_rawDesc
)

func file_network_v1_peer_exchange_proto_rawDescGZIP() []byte {
	file_network_v1_peer_exchange_proto_rawDescOnce.Do(func() {
		file_network_v1_peer_exchange_proto_rawDescData = protoimpl.X.CompressGZIP(file_network_v1_peer_exchange_proto_rawDescData)
	})
	return file_network_v1_peer_exchange_proto_rawDescData
}

var file_network_v1_peer_exchange_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_network_v1_peer_exchange_proto_goTypes = []interface{}{
	(*PeerExchangeMessage)(nil),                 // 0: strims.network.v1.PeerExchangeMessage
	(*PeerExchangeMessage_Request)(nil),         // 1: strims.network.v1.PeerExchangeMessage.Request
	(*PeerExchangeMessage_Response)(nil),        // 2: strims.network.v1.PeerExchangeMessage.Response
	(*PeerExchangeMessage_Offer)(nil),           // 3: strims.network.v1.PeerExchangeMessage.Offer
	(*PeerExchangeMessage_Answer)(nil),          // 4: strims.network.v1.PeerExchangeMessage.Answer
	(*PeerExchangeMessage_IceCandidate)(nil),    // 5: strims.network.v1.PeerExchangeMessage.IceCandidate
	(*PeerExchangeMessage_CallbackRequest)(nil), // 6: strims.network.v1.PeerExchangeMessage.CallbackRequest
}
var file_network_v1_peer_exchange_proto_depIdxs = []int32{
	1, // 0: strims.network.v1.PeerExchangeMessage.request:type_name -> strims.network.v1.PeerExchangeMessage.Request
	2, // 1: strims.network.v1.PeerExchangeMessage.response:type_name -> strims.network.v1.PeerExchangeMessage.Response
	3, // 2: strims.network.v1.PeerExchangeMessage.offer:type_name -> strims.network.v1.PeerExchangeMessage.Offer
	4, // 3: strims.network.v1.PeerExchangeMessage.answer:type_name -> strims.network.v1.PeerExchangeMessage.Answer
	5, // 4: strims.network.v1.PeerExchangeMessage.ice_candidate:type_name -> strims.network.v1.PeerExchangeMessage.IceCandidate
	6, // 5: strims.network.v1.PeerExchangeMessage.callback_request:type_name -> strims.network.v1.PeerExchangeMessage.CallbackRequest
...
func init() { file_network_v1_peer_exchange_proto_init() }
func file_network_v1_peer_exchange_proto_init() {
	if File_network_v1_peer_exchange_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_network_v1_peer_exchange_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_network_v1_peer_exchange_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_network_v1_peer_exchange_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_network_v1_peer_exchange_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_network_v1_peer_exchange_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_network_v1_peer_exchange_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_network_v1_peer_exchange_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
	...
	file_network_v1_peer_exchange_proto_msgTypes[0].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_network_v1_peer_exchange_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_network_v1_peer_exchange_proto_goTypes,
		DependencyIndexes: file_network_v1_peer_exchange_proto_depIdxs,
		MessageInfos:      file_network_v1_peer_exchange_proto_msgTypes,
	}.Build()
	File_network_v1_peer_exchange_proto = out.File
	file_network_v1_peer_exchange_proto_rawDesc = nil
	file_network_v1_peer_exchange_proto_goTypes = nil
	file_network_v1_peer_exchange_proto_depIdxs = nil
}
