...
type CAFindRequest struct {
	...
	//	*CAFindRequest_Subject
	//	*CAFindRequest_SerialNumber
	//	*CAFindRequest_Key
	Query     isCAFindRequest_Query `protobuf_oneof:"query"`
	FullChain bool                  `protobuf:"varint,4,opt,name=full_chain,json=fullChain,proto3" json:"full_chain,omitempty"`
}
...
func (m *CAFindRequest) GetQuery() isCAFindRequest_Query {
	if m != nil {
		return m.Query
	}
	return nil
...
func (x *CAFindRequest) GetSubject() string {
	if x, ok := x.GetQuery().(*CAFindRequest_Subject); ok {
		return x.Subject
	}
	return ""
}
...
func (x *CAFindRequest) GetSerialNumber() []byte {
	if x, ok := x.GetQuery().(*CAFindRequest_SerialNumber); ok {
		return x.SerialNumber
	}
	return nil
}

func (x *CAFindRequest) GetKey() []byte {
	if x, ok := x.GetQuery().(*CAFindRequest_Key); ok {
		return x.Key
	}
	return nil
}
...
type isCAFindRequest_Query interface {
	isCAFindRequest_Query()
}

type CAFindRequest_Subject struct {
	Subject string `protobuf:"bytes,1001,opt,name=subject,proto3,oneof"`
}

type CAFindRequest_SerialNumber struct {
	SerialNumber []byte `protobuf:"bytes,1002,opt,name=serial_number,json=serialNumber,proto3,oneof"`
}

type CAFindRequest_Key struct {
	Key []byte `protobuf:"bytes,1003,opt,name=key,proto3,oneof"`
}

func (*CAFindRequest_Subject) isCAFindRequest_Query() {}

func (*CAFindRequest_SerialNumber) isCAFindRequest_Query() {}

func (*CAFindRequest_Key) isCAFindRequest_Query() {}
...
var file_network_v1_ca_service_proto_rawDesc = []byte{
	...
	,
	...
	0x65, 0x72, 0x74, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x65, 0x32, 0xad, 0x01, 0x0a, 0x02, 0x43,
	...
	,
	...
	0x77, 0x6f, 0x72, 0x6b, 0x2f, 0x76, 0x31, 0x2f, 0x63, 0x61, 0x3b, 0x63, 0x61, 0xba, 0x02, 0x03,
	0x53, 0x4e, 0x43, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
func file_network_v1_ca_service_proto_init() {
	...
	file_network_v1_ca_service_proto_msgTypes[3].OneofWrappers = []interface{}{
		(*CAFindRequest_Subject)(nil),
		(*CAFindRequest_SerialNumber)(nil),
		(*CAFindRequest_Key)(nil),
	}
	type x struct{}
