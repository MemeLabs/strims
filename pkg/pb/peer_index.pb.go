...
func (x *PeerIndexMessage) Reset() {
	*x = PeerIndexMessage{}
	if protoimpl.UnsafeEnabled {
		mi := &file_peer_index_proto_msgTypes[0]
...
func (*PeerIndexMessage) Descriptor() ([]byte, []int) {
	return file_peer_index_proto_rawDescGZIP(), []int{0}
}
...
func (x *PeerIndexMessage_Record) Reset() {
	*x = PeerIndexMessage_Record{}
	if protoimpl.UnsafeEnabled {
		mi := &file_peer_index_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*PeerIndexMessage_Record) Descriptor() ([]byte, []int) {
	return file_peer_index_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *PeerIndexMessage_Publish) Reset() {
	*x = PeerIndexMessage_Publish{}
	if protoimpl.UnsafeEnabled {
		mi := &file_peer_index_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*PeerIndexMessage_Publish) Descriptor() ([]byte, []int) {
	return file_peer_index_proto_rawDescGZIP(), []int{0, 1}
}
...
func (x *PeerIndexMessage_Unpublish) Reset() {
	*x = PeerIndexMessage_Unpublish{}
	if protoimpl.UnsafeEnabled {
		mi := &file_peer_index_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*PeerIndexMessage_Unpublish) Descriptor() ([]byte, []int) {
	return file_peer_index_proto_rawDescGZIP(), []int{0, 2}
}
...
func (x *PeerIndexMessage_SearchRequest) Reset() {
	*x = PeerIndexMessage_SearchRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_peer_index_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*PeerIndexMessage_SearchRequest) Descriptor() ([]byte, []int) {
	return file_peer_index_proto_rawDescGZIP(), []int{0, 3}
}
...
func (x *PeerIndexMessage_SearchResponse) Reset() {
	*x = PeerIndexMessage_SearchResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_peer_index_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*PeerIndexMessage_SearchResponse) Descriptor() ([]byte, []int) {
	return file_peer_index_proto_rawDescGZIP(), []int{0, 4}
}
...
var File_peer_index_proto protoreflect.FileDescriptor

var file_peer_index_proto_rawDesc = []byte{
	0x0a, 0x10, 0x70, 0x65, 0x65, 0x72, 0x5f, 0x69, 0x6e, 0x64, 0x65, 0x78, 0x2e, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x22, 0xe4, 0x05, 0x0a, 0x10, 0x50, 0x65, 0x65, 0x72, 0x49, 0x6e, 0x64, 0x65, 0x78,
	...
	0x73, 0x42, 0x06, 0x0a, 0x04, 0x62, 0x6f, 0x64, 0x79, 0x42, 0x44, 0x0a, 0x15, 0x67, 0x67, 0x2e,
...
var (
	file_peer_index_proto_rawDescOnce sync.Once
	file_peer_index_proto_rawDescData = file_peer_index_proto_rawDesc
)

func file_peer_index_proto_rawDescGZIP() []byte {
	file_peer_index_proto_rawDescOnce.Do(func() {
		file_peer_index_proto_rawDescData = protoimpl.X.CompressGZIP(file_peer_index_proto_rawDescData)
	})
	return file_peer_index_proto_rawDescData
}

var file_peer_index_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_peer_index_proto_goTypes = []interface{}{
	(*PeerIndexMessage)(nil),                // 0: PeerIndexMessage
	(*PeerIndexMessage_Record)(nil),         // 1: PeerIndexMessage.Record
	(*PeerIndexMessage_Publish)(nil),        // 2: PeerIndexMessage.Publish
	(*PeerIndexMessage_Unpublish)(nil),      // 3: PeerIndexMessage.Unpublish
	(*PeerIndexMessage_SearchRequest)(nil),  // 4: PeerIndexMessage.SearchRequest
	(*PeerIndexMessage_SearchResponse)(nil), // 5: PeerIndexMessage.SearchResponse
}
var file_peer_index_proto_depIdxs = []int32{
	2, // 0: PeerIndexMessage.publish:type_name -> PeerIndexMessage.Publish
	3, // 1: PeerIndexMessage.unpublish:type_name -> PeerIndexMessage.Unpublish
	4, // 2: PeerIndexMessage.search_request:type_name -> PeerIndexMessage.SearchRequest
	5, // 3: PeerIndexMessage.search_response:type_name -> PeerIndexMessage.SearchResponse
	1, // 4: PeerIndexMessage.Publish.record:type_name -> PeerIndexMessage.Record
	1, // 5: PeerIndexMessage.Unpublish.record:type_name -> PeerIndexMessage.Record
	1, // 6: PeerIndexMessage.SearchResponse.records:type_name -> PeerIndexMessage.Record
...
func init() { file_peer_index_proto_init() }
func file_peer_index_proto_init() {
	if File_peer_index_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_peer_index_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_peer_index_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_peer_index_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_peer_index_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_peer_index_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_peer_index_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
	...
	file_peer_index_proto_msgTypes[0].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_peer_index_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_peer_index_proto_goTypes,
		DependencyIndexes: file_peer_index_proto_depIdxs,
		MessageInfos:      file_peer_index_proto_msgTypes,
	}.Build()
	File_peer_index_proto = out.File
	file_peer_index_proto_rawDesc = nil
	file_peer_index_proto_goTypes = nil
	file_peer_index_proto_depIdxs = nil
}
