...
class RPCClient {
  ...
  private var callbacks: [UInt64: (PBCall) -> Void] = Dictionary()
  ...
  public func callStreaming<T: Message, R: Message>(_ method: String, _ arg: T) throws
    -> RPCResponseStream<R>
  {
