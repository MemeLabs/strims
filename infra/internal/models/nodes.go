...
var (
	...
	nodeColumnsWithoutDefault = []string{"id", "active", "started_at", "stopped_at", "provider_name", "provider_id", "name", "memory", "cpus", "disk", "ip_v4", "ip_v6", "region_name", "region_lat", "region_lng", "sku_name", "sku_network_cap", "sku_network_speed", "sku_price_monthly", "sku_price_hourly", "wireguard_key", "wireguard_ip", "user"}
