...
var (
	nodeDBTypes = map[string]string{`ID`: `BIGINT`, `Active`: `INTEGER`, `StartedAt`: `INTEGER`, `StoppedAt`: `INTEGER`, `ProviderName`: `TEXT`, `ProviderID`: `TEXT`, `Name`: `TEXT`, `Memory`: `INTEGER`, `CPUs`: `INTEGER`, `Disk`: `INTEGER`, `IPV4`: `TEXT`, `IPV6`: `TEXT`, `RegionName`: `TEXT`, `RegionLat`: `REAL`, `RegionLng`: `REAL`, `SKUName`: `TEXT`, `SKUNetworkCap`: `INTEGER`, `SKUNetworkSpeed`: `INTEGER`, `SKUPriceMonthly`: `REAL`, `SKUPriceHourly`: `REAL`, `WireguardKey`: `TEXT`, `WireguardIP`: `TEXT`, `User`: `TEXT`}
	_           = bytes.MinRead
)
